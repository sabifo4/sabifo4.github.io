...
#### *Apr 2018* 
   ...
   * **Scientific Computing Workshop: A practical introduction to R and Python for researchers**  
      Event sponsored by the SRUK society that I co-organized with Dr. Diego Alonso.      
...
#### *Aug 2018* 
   ...
   * **Comparison of relaxed-clock models using the Bayesian model selection implemented in MCMCtree (_Evolution 2018 poster_)**  
...
#### *Nov 2018* 
   ...
   * **Bayesian estimation of species divergence times using correlated quantitative characters (_YSF18 talk_)**  
      Talk at the YSF2018 1-day symposium on the paper already submitted about the main method I had been working on my PhD.

#### *Mar 2019* 

   * **II Scientific Computing Workshop: A practical introduction to R and Python for researchers**  
      Event sponsored by the SRUK society that I co-organized with Dr. Diego Alonso.
...
Reviewer for _Systematic Biology_, _Bioinformatics_, and _Methods in Ecology and Evolution_.
